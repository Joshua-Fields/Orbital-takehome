...
export function Threads({
  ...
  useEffect(() => {
    ...
    function resize() {
      ...
      (program.uniforms.iResolution.value as Color).b =
    ...
    function update(t: number) {
      ...
      (program.uniforms.iTime as { value: number }).value = t * 0.001;
  ...
  return (
    <div ref={containerRef} className="threads-container" {...rest} />
  );
}
