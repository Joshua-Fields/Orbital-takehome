...
export function DocumentViewer({
  ...
  if (!document) {
    return (
      <div
        style={{ width }}
        className="flex h-full flex-shrink-0 flex-col items-center justify-center border-l border-white/20 bg-white/10 backdrop-blur-md"
      >
        <FileText className="mb-3 h-10 w-10 text-black/30" />
  ...
  return (
    <div
      ref={containerRef}
      style={{ width }}
      className="relative flex h-full flex-shrink-0 flex-col border-l border-white/20 bg-white/10 backdrop-blur-md"
    >
      {/* Resize handle */}
      <div
